#!/usr/bin/env bash
# userdata.sh -  Secured Initialisation Script for OVH Cloud

set -euo pipefail
exec > >(tee /var/log/user-data.log) 2>&1

echo "🛡️ Starting Server Initialization..."
...
echo "🔍 Monitoring: http://$(curl -s ifconfig.me):9100/metrics"
...
echo "✅ Server is ready for production workload!"